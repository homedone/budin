 ...
 * discription
 */
public class ApplicationNodeB {
    Logger logger= LoggerFactory.getLogger(ApplicationNodeB.class);
    public static void main(String[] args) {
        Class<?> clazz= ApplicationNodeB.class;
        //扫包
        String scanPath = clazz.getPackage().getName();
        Set<Class<?>> packageClass = PackageUtil.getPackageClass(scanPath);
        Map<String, Object> yamlMap = YamlUtil.getYamlMap(clazz, "application2.yml");
